...
let _burguesa = new producto(1, 'canelones', 'TheBEST', 1100, 'Clase alta', './img/img-array/canelones1.jpg', false, 1);
...
let _chicken = new producto(6, 'canelones', 'Chicken-little', 1000, 'De pollo y cositas', './img/img-array/canelones4.jpg', false, 1);
let _tuco = new producto(7, 'fideos', 'Moñito', 950, 'Muzza inspiradora', './img/img-array/fideos1.jpg', false, 1);
let _morron = new producto(8, 'fideos', 'Joe-Morrone', 1050, 'Pizza punk', './img/img-array/fideos2.jpg', false, 1);
let _tropi = new producto(9, 'fideos', 'Tropicalisima', 1220, 'Sabor y fiesta', './img/img-array/fideos3.jpg', false, 1);
